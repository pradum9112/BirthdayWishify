...
// NOTE: Disabled in production to prevent duplicate cron jobs.
// To enable locally for dev/testing, uncomment the next function and call it.
// export function startBirthdayCron() {
//   // Run every 1 minutes (for testing)
//   cron.schedule('* * * * *', async () => {
